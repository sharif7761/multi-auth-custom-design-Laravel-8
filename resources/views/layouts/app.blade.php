...
<div class="wrapper">
    ...
    <header class="header_area">
        ...
        <div class="sidebar_logo">
            <a href="index.html">
                <img src="{{asset('panel/assets/images/logo.png')}}" alt="logo" class="img-fluid logo1">
                <img src="{{asset('panel/assets/images/logo_small.png')}}" alt="logo" class="img-fluid logo2">
            </a>
        </div>
                ...
                <div class="dropdown_wrapper messages_item dropdown-menu dropdown-menu-right">
                    ...
                    <ul class="dropdown_body nice_scroll scrollbar">
                        ...
                        <li>
                            <a href="#">
                                <div class="img-part">
                                    <img src="{{asset('/assets/images/user3.jpg')}}" alt="" class="img-fluid">
                                </div>
                                <div class="text-part">
                                    <h6>Olinda <span><i class="far fa-clock"></i> today</span></h6>
                                    <p>Hello jhon...</p>
